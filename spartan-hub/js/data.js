...
window.SPARTAN_HUB = {
  ...
  publicGear: [
    ...
    { level: 'mandatory',  category: '强制', name: '防水冲锋衣' },
    { level: 'mandatory',  category: '强制', name: '手机防水袋' },
    ...
    { level: 'recommended', category: '建议', name: '对讲机' },
    { level: 'optional',   category: '可选', name: '盐丸 × 10' },
